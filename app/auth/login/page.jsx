...
const Login = () => {
    ...
    const [loginData, setLoginData] = useState({
      ...
      const isLoginDataValid = loginData.email.trim() && loginData.password.trim();
...
>
    ...
    <div>
            <h2 className="text-2xl pb-2">
                  Welcome<span className="text-[#A31621]"> Back !</span>{" "}
                </h2>
              ...
              <div className="col-span-2">
                <button
                  disabled={!isLoginDataValid || isSubmitted}
                  type="submit"
                  className={`w-full py-3 rounded-full transition text-sm 
              ${
                isLoginDataValid && !isSubmitted
